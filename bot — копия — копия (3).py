...
RESPONSE_MESSAGES = {
    ...
    'order_prompt': 'Выберите услугу:',
    'faq_prompt': 'Выберите вопрос:',
    'contact_operator_prompt': 'Выберите действие:\n1. Оставить сообщение\n2. Начать чат с оператором',
    'free_chat_entered': 'Вы вошли в режим свободного общения. Нажмите "Перейти к боту", чтобы вернуться.',
    'return_to_bot': 'Вы вернулись к общению с ботом. Давайте помогу Вам?):',
    'order_received': 'Ваш заказ принят. Специалисты уведомлены.',
    'message_received': 'Ваше сообщение отправлено. Специалисты уведомлены.',
    ...
    'all_operators_busy': 'Просим прощения, в данный момент все специалисты заняты. Пожалуйста, попробуйте позже или оставьте сообщение!',
...
def free_chat_keyboard():
    ...
    """
    keyboard = VkKeyboard(one_time=True)
    keyboard.add_button("Перейти к боту", color=VkKeyboardColor.SECONDARY)
    return keyboard
